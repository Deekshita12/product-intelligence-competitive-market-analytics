...
The report consists of **five interactive dashboard pages**, each designed to address a specific business objective.
...
The `.pbix` file exceeds GitHub's maximum file size limit (**100 MB**) and is therefore hosted on Google Drive.

### 🔗 Download

➡️ **[Download Power BI Dashboard](https://drive.google.com/drive/folders/1Yj0pJA_pTLTm3mtZuo0Z1IxY77abQLME?usp=sharing)**

> [!NOTE]
> Download the `.pbix` file from the Google Drive folder and open it using **Microsoft Power BI Desktop**. If prompted, refresh the data source after downloading the processed dataset.
